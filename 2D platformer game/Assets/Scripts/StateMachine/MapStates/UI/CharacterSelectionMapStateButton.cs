...
public class CharacterSelectionMapStateButton : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _stateChangeButton.onClick.AddListener(() => _mStateMachine.OnStateChange(_mStateMachine._characterState, managers));
    }
